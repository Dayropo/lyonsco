...
export const SITE_NAME = "Lyons Company Inc."
...
export const SITE_DESCRIPTION =
  "Representing a network of trusted USA manufacturers specializing in injection molding, precision machining, screw machining, and metal stamping."
export const SITE_SUBDESCRIPTION =
  "We support your projects from early-stage prototype through full-scale production with a focus on quality, consistency, and manufacturability."
export const SITE_CTA_TEXT =
  "Let us simplify your sourcing process and help bring your designs to life — faster and more efficiently."

export const CONTACT_EMAIL = "info@lyonsco.com"
export const CONTACT_PHONE = "(847) 727-8701"
export const CONTACT_PHONE_RAW = "8477278701"
export const CONTACT_NAME = "Mark Morford"
...
export const VALUE_PROPOSITIONS = [
  ...
  },
  {
    ...
    description: "We ensure all partners meet your requirements with unified quality standards.",
    icon: "shield-check",
  },
  {
    id: "cost-optimization",
    title: "Cost Optimization",
    description: "We know which manufacturer is most cost-effective for your specific needs.",
    icon: "dollar-sign",
  },
  {
