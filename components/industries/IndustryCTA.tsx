...
/**
 * CTA section for industry page
 */
export function IndustryCTA({ industryName }: IndustryCTAProps): JSX.Element {
  return (
    <section className="from-primary to-accent relative overflow-hidden bg-gradient-to-br px-6 py-20 sm:py-28">
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        >
          Ready to Start Your {industryName} Project?
        </motion.h2>
        <motion.p
        ...
        >
          Let us help you find the right manufacturing solution for your specific needs
        </motion.p>
        <motion.div
