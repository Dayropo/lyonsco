...
const industries: Industry[] = [
  ...
  },
  {
    id: 'medical',
    name: 'Medical',
    description: 'Sterile components for medical devices',
      ...
      <div className="mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
            We serve precision manufacturing needs across diverse industries, from automotive to
            ...
            <motion.div key={industry.id} variants={cardVariants}>
              ...
              >
                <div className="flex h-full flex-col rounded-lg border border-border bg-card p-6 shadow-sm transition-all hover:shadow-md">
                  ...
                  <h3 className="mt-4 text-lg font-semibold text-card-foreground">{industry.name}</h3>
                  <p className="mt-2 flex-1 text-sm text-muted-foreground">{industry.description}</p>
                  <div className="mt-4 flex items-center text-sm font-semibold text-secondary transition-colors group-hover:text-secondary/80">
                    Learn More
